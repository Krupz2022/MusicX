...
export type Album = {
  ...
  createdAt: string,
  updatedAt: string,
  albumAlbumCategoryId?: string | null,
};
...
export type ModelAlbumConditionInput = {
  ...
  albumAlbumCategoryId?: ModelIDInput | null,
};
...
export type ModelSubscriptionAlbumFilterInput = {
  albumCategoryId?: ModelSubscriptionIDInput | null,
  id?: ModelSubscriptionIDInput | null,
  ...
  artistsHeadline?: ModelSubscriptionStringInput | null,
...
export type AlbumsByAlbumCategoryIdQueryVariables = {
  albumCategoryId: string,
...
export type AlbumsByAlbumCategoryIdQuery = {
...
export type SongsByAlbumIdQueryVariables = {
  albumId: string,
  sortDirection?: ModelSortDirection | null,
  filter?: ModelSongFilterInput | null,
  limit?: number | null,
...
export type SongsByAlbumIdQuery = {
  songsByAlbumId?:  {
    __typename: "ModelSongConnection",
    items:  Array< {
      __typename: "Song",
